import "../styles/StandardDeviation.css"
...
function StandardDeviation({datasets, defaultDatasetIndex }) {
    ...
    <>
        ...
        <Button
            ...
            className="StandardDeviationSettingsButton"><SettingsIcon/></Button>
        <Popover
